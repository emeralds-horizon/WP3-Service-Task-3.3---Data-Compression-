...
def set_backbones(adj_filename, num_of_vertices, num_of_weeks, num_of_days, num_of_hours, k):
    adj_mx = adjacency_matrix(adj_filename, num_of_vertices)  # shape: num_of_vertices * num_of_vertices
